...
import { ButtonStyles, Spinner } from "../../style/Style.styled";
import GiftImage from "../../image/gift.png";
import { useSelector } from "react-redux";

function CartButtomContent() {
  const totalCourseAmount = useSelector(
    (store) => store.course.totalAmountForCourses
  );

  return (
    <BottomTopArea>
      <h5>₦ {totalCourseAmount}</h5>
      <CheckContainer>
        <Check>
          <InputCheckedValue
            type="checkbox"
...
export default CartButtomContent;
