...
const Login = () => {
  ...
  function onGoToForgottenPasswordPage() {
  ...
  function onGoToCreateAccountPageFn() {
    navigate("/signup");
  }
      ...
      <Wrapper>
        ...
        <div className="main">
          ...
          <div className="inputs">
            ...
            <p onClick={onGoToForgottenPasswordPage}>Forgot Password?</p>
          </div>
          <button className="create" onClick={onGoToHomePageFn}>
            Login
          </button>
          <p>Or</p>
          <button className="google">Sign Up with Google</button>
          <p onClick={onGoToCreateAccountPageFn}>New Here? Create Account</p>
        </div>
      </Wrapper>
      <Footer />
    </>
